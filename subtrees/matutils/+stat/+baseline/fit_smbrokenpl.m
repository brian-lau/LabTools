...
switch model
   case {'broken-power1' 'bp1'}
      if ~exist('beta0','var') || isempty(beta0)
         beta0 = [1  -2  1  70];
      end
      lb = [0   -20  0    20];      % lower bounds
      ub = [inf  0   5   150];    % upper bounds
   case {'broken-power' 'bp2'}
      if ~exist('beta0','var') || isempty(beta0)
         beta0 = [1   -2  1  1   70];
      end
      lb = [0   -20  0    0     20];      % lower bounds
      ub = [inf  0   5    5    150];    % upper bounds
